...
class BoardListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BoardViewHolder {
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.board_item, parent, false)
    ...
    inner class BoardViewHolder(private val mBinding: BoardItemBinding) :RecyclerView.ViewHolder(mBinding.root){
